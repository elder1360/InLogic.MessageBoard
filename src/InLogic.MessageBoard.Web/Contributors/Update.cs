...
using FastEndpoints;
using InLogic.MessageBoard.Web.Endpoints.ContributorEndpoints;
using InLogic.MessageBoard.UseCases.Contributors.Create;
using InLogic.MessageBoard.UseCases.Contributors.Update;
using MediatR;
using Ardalis.Result;
using InLogic.MessageBoard.UseCases.Contributors.Get;

namespace InLogic.MessageBoard.Web.ContributorEndpoints;
