...
using InLogic.MessageBoard.Core.ProjectAggregate;
using InLogic.MessageBoard.Core.Services;
using InLogic.MessageBoard.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace InLogic.MessageBoard.UnitTests.Core.Services
{
